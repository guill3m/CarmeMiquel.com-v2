...
<?php elseif (get_field('cm_video_site') == 'youtube_list') : ?>
	<div class="video" style="padding-bottom:<?php echo $video_height; ?>;padding-top:25px;"><iframe src="http://www.youtube.com/embed/videoseries?list=<?php the_field('cm_video_id'); ?>" frameborder="0" seamless webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>
<?php else : // Vimeo ?>
